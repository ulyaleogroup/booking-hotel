      ...
      <div className="container mx-auto text-center">
        <div
          className="text-6xl flex justify-center font-bold md:px-20 pb-10
            ...
            "
        >
          Discover a room and start booking in seconds
        </div>
        ...
        >
          ...
          quidem harum provident sit quis doloribus eveniet vitae architecto
          nihil.
        </p>
        ...
        <div className="pt-10">
          <video className="rounded-xl" autoPlay muted loop>
            <source src="/content/resume.mp4" type="video/mp4" />
          </video>
        </div>
      </div>
    </section>
